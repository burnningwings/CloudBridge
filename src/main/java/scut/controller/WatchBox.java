...
public class WatchBox {
    ...
    public JSONObject watchBoxList(Model model, int page, Integer pageSize, String bridgeName) {
        ...
        try {
            String s = baseDao.querySingleObject(sql, new ResultSetHandler<String>() {
    ...
    @RequestMapping(value = "/bridge/simp-list", method = RequestMethod.GET, produces = "application/json")
    public JSONObject bridgeSimpList() {
